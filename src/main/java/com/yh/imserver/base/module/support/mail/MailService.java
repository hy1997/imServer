package com.yh.imserver.base.module.support.mail;
...
import com.yh.imserver.base.module.support.mail.constant.MailTemplateTypeEnum;
import com.yh.imserver.base.module.support.mail.domain.MailTemplateEntity;
...
//    @Autowired
    ...
    @Value("${spring.mail.username:zhangsan}")
