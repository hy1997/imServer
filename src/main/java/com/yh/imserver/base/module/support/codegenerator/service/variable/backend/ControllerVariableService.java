package com.yh.imserver.base.module.support.codegenerator.service.variable.backend;

import com.google.common.base.CaseFormat;
import com.yh.imserver.base.common.util.SmartEnumUtil;
import com.yh.imserver.base.module.support.codegenerator.constant.CodeDeleteEnum;
    ...
    public List<String> getPackageList(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        if (form.getDeleteInfo().getIsSupportDelete()) {
            ...
            if (codeDeleteEnum == CodeDeleteEnum.BATCH || codeDeleteEnum == CodeDeleteEnum.SINGLE_AND_BATCH) {
                ...
                packageSet.add("import com.yh.imserver.base.common.domain.ValidateList;");
            }
