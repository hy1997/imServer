package com.yh.imserver.base.module.support.codegenerator.service.variable.backend.domain;

import cn.hutool.core.bean.BeanUtil;
import com.yh.imserver.base.common.util.SmartStringUtil;
import com.yh.imserver.base.module.support.codegenerator.constant.CodeFrontComponentEnum;
import com.yh.imserver.base.module.support.codegenerator.domain.form.CodeGeneratorConfigForm;
import com.yh.imserver.base.module.support.codegenerator.domain.model.CodeField;
import com.yh.imserver.base.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
import com.yh.imserver.base.module.support.codegenerator.domain.model.CodeInsertAndUpdateField;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import com.yh.imserver.base.common.swagger.SchemaEnum;");
                packageList.add("import com.yh.imserver.base.common.validator.enumeration.CheckEnum;");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import com.yh.imserver.base.common.json.deserializer.DictValueVoDeserializer;");
            }
            ...
            if (CodeFrontComponentEnum.FILE_UPLOAD.equalsValue(field.getFrontComponent())) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import com.yh.imserver.base.common.json.deserializer.FileKeyVoDeserializer;");
            }
