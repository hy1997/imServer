...
import com.yh.imserver.base.constant.ReloadConst;
import com.yh.imserver.base.module.support.config.domain.*;
import com.yh.imserver.base.module.support.reload.core.annoation.SmartReload;
...
public class ConfigService {
    ...
    private void loadConfigCache() {
        ...
        for (ConfigEntity configEntity : entityList) {
     ...
     *
     */
    public ConfigVO getConfig(ConfigKeyEnum configKey) throws InvocationTargetException, IllegalAccessException {
     ...
     *
     */
    public ConfigVO getConfig(String configKey) throws InvocationTargetException, IllegalAccessException {
