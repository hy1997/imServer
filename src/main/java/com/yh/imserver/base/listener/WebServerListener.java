package com.yh.imserver.base.listener;

import cn.hutool.core.net.NetUtil;
import cn.hutool.core.util.URLUtil;
import lombok.extern.slf4j.Slf4j;
import com.yh.imserver.base.common.code.ErrorCodeRegister;
...
import com.yh.imserver.base.module.support.reload.ReloadCommand;
import com.yh.imserver.base.module.support.reload.core.SmartReloadManager;
...
//        SystemEnvironmentEnum environmentEnum = SmartEnumUtil.getEnumByValue(profile, SystemEnvironmentEnum.class);
        ...
        log.info("ceececce  eeeeeeeeeeeeeeeeeeeeeeee");
        ...
        log.warn("\n{}\n" +
                        ...
                        "\n\tknife4j地址:\t{}" +
                        "\n-------------------------------------------------------------------------------------\n",
                title, profile, "开发", codeCount, localhostUrl, externalUrl, swaggerUrl, knife4jUrl);
    }
