...
import com.yh.imserver.admin.module.system.datascope.domain.DataScopeAndViewTypeVO;
import com.yh.imserver.admin.module.system.datascope.domain.DataScopeDTO;
import com.yh.imserver.admin.module.system.datascope.domain.DataScopeViewTypeVO;
...
public class DataScopeService {
    ...
    public List<DataScopeViewTypeVO> getViewType() {
        List<DataScopeViewTypeVO> viewTypeList = Arrays.asList();
    ...
    public List<DataScopeDTO> getDataScopeType() {
        List<DataScopeDTO> dataScopeTypeList = Arrays.asList();
