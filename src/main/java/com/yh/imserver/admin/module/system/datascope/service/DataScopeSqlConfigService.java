...
import com.yh.imserver.admin.module.system.datascope.DataScope;
...
import com.yh.imserver.admin.module.system.datascope.constant.DataScopeWhereInTypeEnum;
import com.yh.imserver.admin.module.system.datascope.domain.DataScopeSqlConfig;
import com.yh.imserver.admin.module.system.datascope.strategy.AbstractDataScopeStrategy;
...
public class DataScopeSqlConfigService {
    ...
    private Map<String, DataScopeSqlConfig> refreshDataScopeMethodMap() {
        Reflections reflections = new Reflections(new ConfigurationBuilder().setUrls(ClasspathHelper.forPackage("com.yh")).setScanners(new MethodAnnotationsScanner()));
