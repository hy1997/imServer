package com.yh.imserver.admin.module.system.employee.service;
...
import com.yh.imserver.admin.module.system.employee.domain.form.*;
import com.yh.imserver.admin.module.system.employee.domain.vo.EmployeeVO;
import com.yh.imserver.admin.module.system.employee.manager.EmployeeManager;
import com.yh.imserver.admin.module.system.login.service.LoginService;
import com.yh.imserver.admin.module.system.position.dao.PositionDao;
import com.yh.imserver.admin.module.system.position.domain.entity.PositionEntity;
import com.yh.imserver.admin.module.system.role.dao.RoleEmployeeDao;
import com.yh.imserver.admin.module.system.role.domain.vo.RoleEmployeeVO;
...
public class EmployeeService {
    ...
    public ResponseDTO<PageResult<EmployeeVO>> queryEmployee(EmployeeQueryForm employeeQueryForm) {
        ...
        employeeList.forEach(e -> {
            e.setRoleIdList(employeeRoleIdListMap.getOrDefault(e.getEmployeeId(), Arrays.asList()));
            e.setRoleNameList(employeeRoleNameListMap.getOrDefault(e.getEmployeeId(), Arrays.asList()));
