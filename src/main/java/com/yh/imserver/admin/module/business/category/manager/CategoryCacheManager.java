package com.yh.imserver.admin.module.business.category.manager;

import com.yh.imserver.admin.constant.AdminCacheConst;
...
public class CategoryCacheManager {
    ...
    public List<CategoryEntity> querySubCategory(Long categoryId) {
        return categoryDao.queryByParentId(Arrays.asList(categoryId), false);
    }
    ...
    private void queryAndSetSubCategory(List<CategoryTreeVO> treeList, List<CategoryEntity> allCategoryEntityList) {
        ...
        treeList.forEach(e -> {
            List<CategoryEntity> childrenEntityList = categorySubMap.getOrDefault(e.getValue(), Arrays.asList());
