package com.yh.imserver.admin.module.system.datascope.service;

import com.yh.imserver.admin.module.system.datascope.constant.DataScopeTypeEnum;
import com.yh.imserver.admin.module.system.datascope.constant.DataScopeViewTypeEnum;
...
import com.yh.imserver.admin.module.system.role.dao.RoleDataScopeDao;
import com.yh.imserver.admin.module.system.role.dao.RoleEmployeeDao;
import com.yh.imserver.admin.module.system.role.domain.entity.RoleDataScopeEntity;
...
public class DataScopeViewService {
    ...
    public List<Long> getMeDepartmentIdList(Long employeeId) {
        ...
        return Arrays.asList(employeeEntity.getDepartmentId());
    }
    ...
    public DataScopeViewTypeEnum getEmployeeDataScopeViewType(DataScopeTypeEnum dataScopeTypeEnum, Long employeeId) {
        ...
        List<RoleDataScopeEntity> viewLevelList = listMap.getOrDefault(dataScopeTypeEnum.getValue(), Arrays.asList());
