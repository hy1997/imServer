package com.yh.imserver.netty.mqtt.client.handler.channel;
...
public final class MqttChannelHandler extends SimpleChannelInboundHandler<MqttMessage> implements ChannelOutboundHandler {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        String clientId = channel.attr(com.yh.imserver.netty.mqtt.client.constant.MqttConstant.MQTT_CLIENT_ID_ATTRIBUTE_KEY).get();
    ...
    private void connectSuccessHandle(Channel channel, MqttConnAckMessage mqttConnAckMessage) {
        ...
        channel.attr(com.yh.imserver.netty.mqtt.client.constant.MqttConstant.KEEP_ALIVE_TIME_ATTRIBUTE_KEY).set(keepAliveTimeSeconds);
        //1000要加L 不然会溢出
        ...
        channel.pipeline().addBefore(com.yh.imserver.netty.mqtt.client.constant.MqttConstant.NETTY_DECODER_HANDLER_NAME, MqttConstant.NETTY_IDLE_HANDLER_NAME, new IdleStateHandler(readIdleMills, 0, 0, TimeUnit.MILLISECONDS));
        //心跳定时任务间隔执行
